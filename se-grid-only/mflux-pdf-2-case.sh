...
ncl 'dir="'$data_dir'"' 'fname0="'$case1'"' 'fincl0="'$fincl1'"' $ncl_dir/moistflux.ncl

ncl 'dir="'$data_dir'"' 'fname0="'$case2'"' 'fincl0="'$fincl2'"' $ncl_dir/moistflux.ncl

ncl 'fname1="'$case1'"' 'fname2="'$case2'"' $ncl_dir/plot-moistflux.ncl
